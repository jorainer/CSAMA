...
<div>
<img src="images/SLC22A5.png" width = 500>
</div>

<div style="position:absolute; left:55%; top:25%;">
<img src="images/Carnitine.png" width = 200/>
<img src="images/Acetylcarnitine.png" width = 200/>
<img src="images/butyrylcarnitine.png" width = 200/>
</div>

<div style="postition:absolute; left: 40px; top:90%;">
...
- Need to *annotate* these to metabolites (compounds).
...
<div>
- Apply *collision energy* to fragment ions.
</div>
<div>
...
<div style="position:absolute; left:25%; top:358px;">
```{r, eval = FALSE}
...
<div style="position:absolute; left:25%; top:513px;">
```{r, eval = FALSE}
...
- Preprocessing:
  [metabolomics2018](https://github.com/jorainer/metabolomics2018).
